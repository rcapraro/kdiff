...
private object EntryPatcher : Differ<Entry> by differ({
    field(Entry::id)
    field(Entry::street)
}),
    Patcher<Entry> {
...
class PatchKeyedListSpec : FunSpec({
...
class PatchPositionalListSpec : FunSpec({
...
class PatchFailureReasonSpec : FunSpec({
